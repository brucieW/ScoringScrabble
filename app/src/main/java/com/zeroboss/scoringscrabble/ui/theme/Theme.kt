package com.zeroboss.scoringscrabble.ui.theme
...
object ScoringScrabbleTheme {
    val colors: ScoringScrabbleColors
        @Composable
...
class ScoringScrabbleColors(
    ...
    fun update(other: ScoringScrabbleColors) {
...
private val LocalScoring500Colors = staticCompositionLocalOf<ScoringScrabbleColors> {
